                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" value="{{ $h->mesin->nama_mesin ?? '-' }}" readonly style="background-color: #f8f9fa; cursor: not-allowed;">
                                <label>Nama Mesin</label>
                                {{-- Hidden input untuk mengirim mesin_id --}}
                                <input type="hidden" name="mesin_id" value="{{ $h->mesin_id }}">
                                                    </div>
                                                    <div class="form-floating mb-3">
